              ...
              <tr key={user.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                  {(currentUser?.role === UserRole.SYSTEM_ADMIN || 
                    (currentUser?.role === UserRole.COMPANY_ADMIN && user.role === UserRole.USER)) && (
                    <>
                      <button 
                  ...
                  <div>
                    ...
                    <div className="mt-3 text-center sm:mt-5">
                      <Dialog.Title as="h3" className="text-xl font-semibold leading-6 text-gray-900">
                        {userToEdit ? 'Kullanıcı Düzenle' : 'Yeni Kullanıcı Ekle'}
                      </Dialog.Title>
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          {userToEdit 
                            ? 'Kullanıcı bilgilerini düzenleyin' 
                            : 'Yeni bir kullanıcı eklemek için formu doldurun.'}
                        </p>
                      </div>
                    </div>
                    <div className="mt-5 sm:mt-6 sm:mb-2">
                      <UserForm 
